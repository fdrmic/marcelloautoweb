  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-gray-950 text-white">
      <main className="flex-1 pt-16">
        {/* Hero Section */}
        <section className="relative w-full h-[20vh] sm:h-[22vh] md:h-[25vh] lg:h-[30vh] flex items-center justify-center text-center overflow-hidden bg-gray-950">
          {/* Content */}
          <div className="relative z-10 space-y-2 sm:space-y-3 md:space-y-4 px-4 md:px-6 flex flex-col items-center justify-center h-full">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight text-white drop-shadow-2xl">
              Unsere
              <br />
              <span className="text-[#FF0000] drop-shadow-[0_0_30px_rgba(255,0,0,0.3)]">Dienstleistungen</span>
            </h1>
            <p className="max-w-3xl mx-auto text-sm sm:text-base md:text-lg lg:text-xl text-gray-200 drop-shadow-lg leading-relaxed px-2 sm:px-4">
        ...
        <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-900 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center">
              ...
              <div className="space-y-3 sm:space-y-4 md:space-y-6">
                ...
                <div className="space-y-2 sm:space-y-3 md:space-y-4">
                  <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-white">Unsere Leistungen im Überblick:</h3>
                  <div className="space-y-2 md:space-y-3">
                    <div className="flex items-start gap-2 md:gap-3">
                      <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-[#FF0000] mt-1 flex-shrink-0" />
              ...
              {/* Image Placeholder */}
              <div className="bg-gray-800 rounded-lg h-48 sm:h-56 md:h-64 lg:h-80 xl:h-96 flex items-center justify-center">
                <Image
                  src="/reparatur.jpg"
        ...
        <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-950 relative">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center">
              {/* Image Placeholder */}
              <div className="bg-gray-800 rounded-lg h-48 sm:h-56 md:h-64 lg:h-80 xl:h-96 flex items-center justify-center order-2 lg:order-1">
                <Image
                  src="/lackieren.jpg"
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-gray-950 relative">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              {/* Image Placeholder */}
              <div className="bg-gray-800 rounded-lg h-64 sm:h-72 md:h-80 lg:h-96 flex items-center justify-center order-2 lg:order-1">
                <Image
                  src="/reifen.jpg"
              ...
              <div className="space-y-4 sm:space-y-5 md:space-y-6 order-1 lg:order-2">
                ...
                <div className="bg-[#FF0000]/10 border-l-4 border-[#FF0000] p-3 sm:p-4 rounded-r-lg">
                  <p className="text-white font-medium text-xs sm:text-sm md:text-base">
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-gray-900 relative">
          <div className="max-w-6xl mx-auto px-4 md:px-6 text-center">
            ...
            <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed mb-6 sm:mb-8 md:mb-10 px-2">
            ...
            <div className="flex justify-center">
              <Link href="/kontakt">
                <Button
                  size="lg"
                  className="bg-[#FF0000] text-white hover:bg-[#E60000] text-base sm:text-lg px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full shadow-[0_0_20px_rgba(255,0,0,0.3)] hover:shadow-[0_0_30px_rgba(255,0,0,0.5)] transition-all duration-300 hover:scale-105"
                >
