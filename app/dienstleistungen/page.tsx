  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-gray-950 text-white">
      <main className="flex-1 pt-16">
        {/* Hero Section */}
        <section className="relative w-full h-[60vh] flex items-center justify-center text-center overflow-hidden bg-gray-950">
          {/* Content */}
          <div className="relative z-10 space-y-6 px-4 md:px-6">
            ...
            <p className="max-w-3xl mx-auto text-xl md:text-2xl text-gray-200 drop-shadow-lg leading-relaxed">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gray-800 rounded-lg h-96 flex items-center justify-center">
                <div className="text-center text-gray-400">
                  ...
                  <p className="text-lg">Bild: Reparatur & Wartung</p>
                  <p className="text-sm">Platzhalter für passendes Bild</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gray-800 rounded-lg h-96 flex items-center justify-center order-2 lg:order-1">
                <div className="text-center text-gray-400">
                  <div className="text-6xl mb-4"></div>
                  <p className="text-lg">Bild: Karosserie & Lackierung</p>
                  <p className="text-sm">Platzhalter für passendes Bild</p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  Sie möchten Ihr Auto verkaufen oder suchen ein neues? Bei Auto RiKu sind Sie richtig. Wir bieten faire Preise beim Ankauf und geprüfte Occasionen mit Garantie.
                </p>
              ...
              <div className="bg-gray-800 rounded-lg h-96 flex items-center justify-center">
                <div className="text-center text-gray-400">
                  <div className="text-6xl mb-4"></div>
                  <p className="text-lg">Bild: Fahrzeug An- & Verkauf</p>
                  <p className="text-sm">Platzhalter für passendes Bild</p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gray-800 rounded-lg h-96 flex items-center justify-center order-2 lg:order-1">
                <div className="text-center text-gray-400">
                  <div className="text-6xl mb-4"></div>
                  <p className="text-lg">Bild: Reifen & Räder</p>
                  <p className="text-sm">Platzhalter für passendes Bild</p>
                </div>
              </div>
